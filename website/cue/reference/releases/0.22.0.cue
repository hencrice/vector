...
releases: "0.22.0": {
	...
	changelog: [
		...
		},
		{
			...
			description: """
				All sources now emit consistent metrics in accordance with Vector's [component
				specification](https://github.com/vectordotdev/vector/blob/927fd2eeb4ee15b10f8c046f0f9347789ca1c356/docs/specs/component.md).
				"""
			pr_numbers: [12572]
		},
		{
			type: "enhancement"
			scopes: ["transforms", "observability"]
			description: """
				All transforms now emit consistent metrics in accordance with Vector's [component
				specification](https://github.com/vectordotdev/vector/blob/927fd2eeb4ee15b10f8c046f0f9347789ca1c356/docs/specs/component.md).
				"""
			pr_numbers: [12668]
		},
